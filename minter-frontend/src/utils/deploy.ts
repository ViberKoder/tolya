...
// These are the REAL Jetton 2.0 compiled contracts from the official repository
// ============================================================================
...
export async function deployJettonMinter(
  ...
  try {
    ...
    // Structure: total_supply:Coins admin_address:MsgAddress content:^Cell wallet_code:^Cell
    ...
    const mintBody = beginCell()
      ...
      .storeCoins(toNano('0.05')) // ton_amount for gas
